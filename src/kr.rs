...
pub fn gpke(bw: &Vec<f64>, data: ArrayView2<f64>, data_predict: ArrayView1<f64>, var_type: Vec<&str>) -> Array1<f64> {
...
pub fn est_loc_constant(bw: &Vec<f64>, data_endog: ArrayView1<f64>, data_exog: ArrayView2<f64>, data_predict: ArrayView1<f64>, var_type: Vec<&str>) -> f64 {
...
pub fn loc_constant_fit(bw: &Vec<f64>, data_endog: ArrayView1<f64>, data_exog: ArrayView2<f64>, data_predict: ArrayView2<f64>, var_type: Vec<&str>) -> Vec<f64> {
    ...
    for i in 0..n_predict {
        ...
        let local_mean = est_loc_constant(&bw, data_endog, data_exog, slice_predict, var_type.clone());
